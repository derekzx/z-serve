...
class Eth extends AbstractWeb3Module {
  constructor(provider, providersModuleFactory, methodModuleFactory, methodFactory, net, accounts, personal, Iban$$1, abiCoder, ens, utils, formatters$$1, subscriptionsFactory, contractModuleFactory, transactionSigner, options) {
...
const Eth$1 = (provider, options) => {
  ...
  return new Eth(provider, new ProvidersModuleFactory(), methodModuleFactory, new MethodFactory$1(), new Network(provider, options), accounts, new Personal(provider, accounts, options), Iban, abiCoder, new Ens(provider, accounts, options), Utils, formatters, new SubscriptionsFactory(), new ContractModuleFactory(Utils, formatters, abiCoder, accounts, methodModuleFactory), new TransactionSigner$1(), options);
};
