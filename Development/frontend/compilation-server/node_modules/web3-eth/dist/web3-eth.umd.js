(function (global, factory) {
    ...
    function (_AbstractWeb3Module) {
      ...
      function Eth(provider, providersModuleFactory, methodModuleFactory, methodFactory, net, accounts, personal, Iban, abiCoder, ens, utils, formatters, subscriptionsFactory, contractModuleFactory, transactionSigner, options) {
        var _this;
    ...
    var Eth$1 = function Eth$$1(provider, options) {
      ...
      return new Eth(provider, new web3Providers.ProvidersModuleFactory(), methodModuleFactory, new MethodFactory$1(), new web3Net.Network(provider, options), accounts, new web3EthPersonal.Personal(provider, accounts, options), web3EthIban.Iban, abiCoder, new web3EthEns.Ens(provider, accounts, options), Utils, web3CoreHelpers.formatters, new web3CoreSubscriptions.SubscriptionsFactory(), new web3EthContract.ContractModuleFactory(Utils, web3CoreHelpers.formatters, abiCoder, accounts, methodModuleFactory), new TransactionSigner$1(), options);
    };
